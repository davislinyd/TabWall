...
const I18N = {
  zh: {
    ...
    helpShortcutQuickSearch: '在任何分頁搜尋已存項目（不必開啟 TabWall）。tag／group／note／nn／noti／domain + Tab 切換欄位',
  ...
  en: {
    ...
    helpShortcutQuickSearch: 'Search parked items on any tab (without opening TabWall). tag / group / note / nn / noti / domain + Tab to change field',
