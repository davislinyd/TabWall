...
const I18N = {
  zh: {
    ...
    helpShortcutQuickSearch: '在任何分頁搜尋已停駐項目（Option+/）',
    canvasRaiseDepth: '提到前面',
    canvasLowerDepth: '送到後面',
    themeTitle: '主題',
    fxTitle: '視覺效果',
  ...
  en: {
    ...
    helpShortcutQuickSearch: 'Search parked items on any tab (Option+/)',
    canvasRaiseDepth: 'Bring forward',
    canvasLowerDepth: 'Send back',
    themeTitle: 'Theme',
