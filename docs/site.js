(function () {
  ...
  var COPY = {
    zh: {
      title: "TabWall 使用者說明",
      description: "TabWall 2.46.1 使用者說明：儲存分頁與 Tab Group、未停車標註、頁面繪圖層、空間畫布、本機 AI agent、卡片上鎖、自訂標題、圖片卡、自訂背景、搜尋、備份與隱私。",
      skip: "跳到本文",
      brand: "使用者說明 · v2.46.1",
      find: "搜尋手冊…",
    ...
    en: {
      ...
      description: "TabWall 2.46.1 user guide: park tabs and Tab Groups, live page notes, drawing layer, spatial canvas, local AI agent, card lock, display titles, image cards, custom background, search, backup, and privacy.",
      skip: "Skip to content",
      brand: "User guide · v2.46.1",
