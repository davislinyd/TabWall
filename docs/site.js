(function () {
  ...
  var COPY = {
    zh: {
      title: "TabWall 使用者說明",
      description: "TabWall 2.55.3 使用者說明：儲存分頁與 Tab Group、可設定的新分頁、未停車標註、頁面繪圖與 Sticker、空間畫布、本機 AI agent、單一 HTML Sticker Note 與獨立縮放、來源網頁、卡片上鎖、自訂標題、圖片卡、自訂背景、搜尋、備份與隱私。",
      skip: "跳到本文",
      brand: "使用者說明 · v2.55.3",
      find: "搜尋手冊…",
      empty: "手冊中沒有符合的段落。試試「繪圖」「標註」「AI」「上鎖」「備份」「硬碟」「搜尋」或「快捷鍵」。",
      toc: "目錄",
      themeLight: "淺色",
      themeDark: "深色",
      langOther: "EN",
    ...
    en: {
      ...
      description: "TabWall 2.55.3 user guide: park tabs and Tab Groups, configurable New Tab, live page notes, drawing and page Stickers, spatial canvas, local AI agent, single-document HTML Sticker Notes with independent resizing, source pages, card lock, display titles, image cards, custom background, search, backup, and privacy.",
      skip: "Skip to content",
      brand: "User guide · v2.55.3",
      find: "Search the guide…",
      empty: "No matching section. Try “draw”, “annotate”, “AI”, “lock”, “backup”, “disk”, “search”, or “shortcut”.",
      toc: "Contents",
      themeLight: "Light",
      themeDark: "Dark",
      langOther: "中文",
