(function () {
  ...
  var COPY = {
    zh: {
      title: "TabWall 使用者說明",
      description: "TabWall 2.43.11 使用者說明：儲存分頁與 Tab Group、空間畫布、本機 AI agent、卡片上鎖、自訂標題、圖片卡、自訂背景、搜尋、備份與隱私。",
      skip: "跳到本文",
      brand: "使用者說明 · v2.43.11",
      find: "搜尋手冊…",
      empty: "手冊中沒有符合的段落。試試「AI」「上鎖」「自訂標題」「備份」「硬碟」「搜尋」或「快捷鍵」。",
      toc: "目錄",
      themeLight: "淺色",
      themeDark: "深色",
      langOther: "EN",
    ...
    en: {
      ...
      description: "TabWall 2.43.11 user guide: park tabs and Tab Groups, spatial canvas, local AI agent, card lock, display titles, image cards, custom background, search, backup, and privacy.",
      skip: "Skip to content",
      brand: "User guide · v2.43.11",
      find: "Search the guide…",
      empty: "No matching section. Try “AI”, “lock”, “title”, “backup”, “disk”, “search”, or “shortcut”.",
      toc: "Contents",
      themeLight: "Light",
      themeDark: "Dark",
      langOther: "中文",
