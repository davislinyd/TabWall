(function () {
  ...
  var COPY = {
    zh: {
      title: "TabWall 使用者說明",
      description: "TabWall 2.40.3 使用者說明：儲存分頁與 Tab Group、空間畫布、卡片上鎖、自訂標題、圖片卡、自訂背景、搜尋、備份、硬碟用量與隱私。",
      skip: "跳到本文",
      brand: "使用者說明 · v2.40.3",
      find: "搜尋手冊…",
    ...
    en: {
      ...
      description: "TabWall 2.40.3 user guide: park tabs and Tab Groups, spatial canvas, card lock, display titles, image cards, custom background, search, backup, disk usage, and privacy.",
      skip: "Skip to content",
      brand: "User guide · v2.40.3",
