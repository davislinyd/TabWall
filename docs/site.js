(function () {
  ...
  var COPY = {
    zh: {
      title: "TabWall 使用者說明",
      description: "TabWall 2.57.0 使用者說明：儲存分頁與 Tab Group、可設定的新分頁、GitHub Release 更新檢查、未停車標註、頁面繪圖與 Sticker、空間畫布、本機 AI agent、單一 HTML Sticker Note 與獨立縮放、來源網頁、卡片提醒、Webhook profiles、卡片上鎖、自訂標題、圖片卡、自訂背景、搜尋、備份與隱私。",
      skip: "跳到本文",
      brand: "使用者說明 · v2.57.0",
      find: "搜尋手冊…",
