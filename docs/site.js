(function () {
  ...
  var COPY = {
    zh: {
      title: "TabWall 使用者說明",
      description: "TabWall 2.35.0 使用者說明：儲存分頁與 Tab Group、空間畫布、自訂背景、搜尋、備份與隱私。",
      skip: "跳到本文",
      brand: "使用者說明 · v2.35.0",
      find: "搜尋手冊…",
    ...
    en: {
      ...
      description: "TabWall 2.35.0 user guide: park tabs and Tab Groups, spatial canvas, custom background, search, backup, and privacy.",
      skip: "Skip to content",
      brand: "User guide · v2.35.0",
